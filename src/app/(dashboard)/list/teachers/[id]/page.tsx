      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-skyLight" href={`/list/classes?supervisorId=${"teacher1"}`}>
              {"Teacher's Classes"}
            </Link>
            <Link className="p-3 rounded-md bg-purpleLight" href={`/list/students?teacherId=${"teacher1"}`}>
              {"Teacher's Students"}
            </Link>
            <Link className="p-3 rounded-md bg-yellowLight" href={`/list/lessons?teacherId=${"teacher1"}`}>
              {"Teacher's Lessons"}
            </Link>
            <Link className="p-3 rounded-md bg-pink-50" href={`/list/exams?teacherId=${"teacher1"}`}>
              {"Teacher's Exams"}
            </Link>
            <Link className="p-3 rounded-md bg-sky" href={`/list/assignments?teacherId=${"teacher1"}`}>
